...
class Gmail:
    ...
    def _load_env(self):
        ...
        self.READ_SCOPES = ["https://www.googleapis.com/auth/gmail.readonly"]
        self.MOD_SCOPES = ["https://www.googleapis.com/auth/gmail.modify"]
    ...
    def _authorize_new_token(self, creds_path):
        flow = InstalledAppFlow.from_client_secrets_file(creds_path, self.MOD_SCOPES)
        self.creds = flow.run_local_server(port=0)


    def _token_manager(self, todo=None, credentials=None):
        credentials_path = './gmail/app_info/credentials.json'
        token_path = './gmail/app_info/token.json'
        ...
        if todo == "set":
            ...
            try:
                self.creds = Credentials.from_authorized_user_file(token_path, self.MOD_SCOPES)
