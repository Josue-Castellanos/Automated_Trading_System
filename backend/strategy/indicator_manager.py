...
def indicator_manager(data, indicator_settings):
    ...
    for indicator in indicator_settings:
        try:
            ...
            if indicator_name == "EMA":
                ...
                indicator_data["SMA50_slope"] = (
                    indicator_data["SMA50"]
                    .rolling(window=20)
                    .apply(lambda x: np.polyfit(range(20), x, 1)[0], raw=True)
                )
    ...
    return {"price_data": price_data, "indicators": indicator_data}
